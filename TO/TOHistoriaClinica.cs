...
namespace TO
{
    public class TOHistoriaClinica
    {
        ...
        public TOHistoriaClinica(string cod, float apTalla, float apPeso, float apPerimetro, string apCalificacionU, decimal apAPGAR, decimal apEdad, Boolean apOtrasCom, string apDescripcionOtras)
        {
            this.Codigo = cod;
