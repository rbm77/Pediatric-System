...
namespace TO
{
    public class TOExamenFisico
    {
        ...
        public TOExamenFisico(string codMed, string codExp, DateTime fecha, float talla, float peso, float perimetro, float so2, string alerta, string hidratacion, string ruidos, string campos, string abdomen, string faringe,
