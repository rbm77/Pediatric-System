    ...
    <div class="container-fluid col-11 col-auto">
        ...
        <div style="margin-top: 15px">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active tabs-fichas" id="primera-parte-tab" data-toggle="tab" href="#ef-primera-parte" role="tab" aria-controls="ef-primera-parte" aria-selected="true">I Parte Examen Físico</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="segunda-parte-tab" data-toggle="tab" href="#ef-segunda-parte" role="tab" aria-controls="ef-segunda-parte" aria-selected="false">II Parte Examen Físico</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="examen-laboratorio-tab" data-toggle="tab" href="#examen-laboratorio" role="tab" aria-controls="examen-laboratorio" aria-selected="false">Examen de Laboratorio</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="diagnostico-nutricional-tab" data-toggle="tab" href="#diagnostico-nutricional" role="tab" aria-controls="diagnostico-nutricional" aria-selected="false">Diagnóstico Nutricional</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="analisis-tab" data-toggle="tab" href="#consulta-analisis" role="tab" aria-controls="consulta-analisis" aria-selected="false">Análisis</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="diagnostico-tab" data-toggle="tab" href="#consulta-diagnostico" role="tab" aria-controls="consulta-diagnostico" aria-selected="false">Impresión Diagnóstica</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="plan-tab" data-toggle="tab" href="#consulta-plan" role="tab" aria-controls="consulta-plan" aria-selected="false">Plan</a>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active margen-general-1-bottom" id="ef-primera-parte" role="tabpanel" aria-labelledby="ef-primera-parte-tab" style="margin-bottom: 25px;">
            ...
            <div class="tab-pane fade margen-general-1-bottom" id="ef-segunda-parte" role="tabpanel" aria-labelledby="ef-segunda-parte-tab" style="margin-bottom: 25px;">
            ...
            <div class="tab-pane fade" id="examen-laboratorio" role="tabpanel" aria-labelledby="examen-laboratorio-tab" style="margin-bottom: 25px;">
                <div class="col-12 border rounded" style="margin-top: 15px">
            ...
            <div class="tab-pane fade margen-general-1-bottom" id="diagnostico-nutricional" role="tabpanel" aria-labelledby="diagnostico-nutricional-tab" style="margin-bottom: 25px;">
                <div class="col-12 border rounded margen-general-2-top">
            ...
            <div class="tab-pane fade margen-general-1-bottom" id="consulta-analisis" role="tabpanel" aria-labelledby="consulta-analisis-tab">
                <div class="col-12 border rounded margen-general-2-top margen-general-1-bottom padding-general-inicio-top">
        ...
        <div class="btnGuardarConsulta form-group col-lg-3 col-md-6 col-sm-6 col-xs-6">
