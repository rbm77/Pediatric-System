...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form>
        ...
        <div class="container-fluid col-10 col-auto">
            ...
            <div class="card">
                <h5 class="card-header text-center">Cuentas del Personal de la Clínica</h5>
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <button type="button" class="btn btn-outline-success form-control">CREAR CUENTA</button>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <button type="submit" class="btn btn-outline-success form-control">GESTIONAR ESTADOS</button>
