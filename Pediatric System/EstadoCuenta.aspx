                    ...
                    <div>
                        <asp:GridView ID="gridCuentas" runat="server" AutoGenerateColumns="false" class="table table-hover"
                            ...
                            <Columns>
                                ...
                                <ItemTemplate>
                                  <asp:Button ID="btnEditar" ControlStyle-CssClass="btn btn-neutro fas fa-edit" ControlStyle-Width="33.3%" runat="server" ClientIDMode= Static Text="Editar" OnClick="btnEditar_Click"/>
