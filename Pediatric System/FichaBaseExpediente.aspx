...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid col-11 col-auto">
        ...
        <div class="padding-general-bottom">
            <div class="btnVerConsultas col-lg-3 col-md-6 col-sm-6 col-xs-6">
                <button type="submit" class="btn btn-info form-control">Consultas</button>
            </div>
        </div>
        ...
        <div class="margen-general-2-top">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active tabs-fichas" id="info-personal-paciente-tab" data-toggle="tab" href="#info-personal-paciente" role="tab" aria-controls="info-personal-paciente" aria-selected="true">Inf. del Paciente</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="info-personal-encargado-tab" data-toggle="tab" href="#info-personal-encargado" role="tab" aria-controls="info-personal-encargado" aria-selected="false">Inf. del Encargado</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="info-personal-facturante-tab" data-toggle="tab" href="#info-personal-facturante" role="tab" aria-controls="info-personal-facturante" aria-selected="false">Inf. del Facturante</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link tabs-fichas" id="vacunas-tab" data-toggle="tab" href="#vacunas" role="tab" aria-controls="vacunas" aria-selected="false">Vacunas</a>
                </li>
            </ul>
        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-row padding-general-checkB">
                                            <div class="form-check col-lg-3 col-md-12 col-sm-12 col-xs-12">
