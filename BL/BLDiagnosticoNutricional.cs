...
namespace BL
{
    public class BLDiagnosticoNutricional
    {
        ...
        public BLDiagnosticoNutricional ()
        {

        }

        public BLDiagnosticoNutricional(string codMed, string codExpe, DateTime fecha, string pesoEdad, string tallaEdad0, string cefalicoEdad, string pesoTalla, string imcEdad, string tallaEdad5)
        {
