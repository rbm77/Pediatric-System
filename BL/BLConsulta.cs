...
namespace BL
{
    public class BLConsulta
    {
        ...
        public BLConsulta(string codMedico, string codExpediente, DateTime fecha, string analisis, string impresion, string plan, Boolean medicinaMix, string frecuencia, string refererido, Boolean estado, string padecimiento, Boolean referencia, string especialidad, string motivo, string paciente)
        {
            this.CodigoMedico = codMedico;
            this.CodigoExpediente = codExpediente;
            this.Fecha_Hora = fecha;
